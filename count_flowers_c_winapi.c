...
int main() {
void drawf(); 
printf("__ Count Flowers C by OlegTim __ \n\nPress <num> to start - for example, <1> \n") ;
printf("\nCount the number of flowers by colour, shape or both. \n");
printf("Press any number button (0-9) to answer, \ncheck if it's right and continue. \n");
printf("\n\nIf needed, adjust console to fit 4 columns \n");
printf("and 3 rows of flowers and 3 text rows below. \n");
printf("Tested at 650*460 pix console, 80 letters (8*12 pix each) in 33 lines.\n");
...
printf("%d", answ);
printf(" is OK! Press <num> for new game\n");
drawansw();
}
else {phase=3;
printf("%d", answ);
printf(" is wrong. The answer is: ");
printf("%d", randt);
printf(". Press <num> for new game\n"); 
drawansw();	
}		  	
}}}
}
...
if (arrc[12]==0){
   				 int i;
for ( i = 0; i<12; i++){if (arrs[i]==arrs[12]){m++;}}   				 
}else{if (arrs[12]==0){
		 int i;
for ( i = 0; i<12; i++){if (arrc[i]==arrc[12]){m++;}} 		 
}else{
	  int i;
for ( i = 0; i<12; i++){if (arrs[i]==arrs[12]&&arrc[i]==arrc[12]){m++;}} 	  
	  }}
return m;
}
...
int m=0;
int i;
for ( i =0; i <(counter+1)*3; i++){ m = rand();} 
m=m%100;
return m;	
	}
...
int getrandc(){
	 int m =0;
	 int i;
for ( i =0; i <randt+randseed+counter; i++){
	 m = rand();} 
if (m<10){m=(m+1)*10;}
m = m%10;
...
int getrands(){
	 int m =0;
	 int i;
for ( i =0; i <randt+randseed+counter+1; i++){
	 m = rand();} 
if (m<10){m=(m+1)*10;}
m = m%10;
...
void clearf(){
	 int i;
for ( i = 0; i<13; i++){arrc[i]=0; arrs[i]=0;}
counter=0;	 
}
...
if (arrc[12]==1){strcpy(sc, "green ");}
if (arrc[12]==2){strcpy(sc, "blue ");}	
if (arrc[12]==3){strcpy(sc, "yellow ");}	
if (arrc[12]==4){strcpy(sc, "aque ");}	
if (arrc[12]==5){strcpy(sc, "violet ");}
if (arrc[12]==6){strcpy(sc, "red ");}	
if (arrc[12]==7){strcpy(sc, "white ");}

char sh[10];
if (arrs[12]==1){strcpy(sh, "bubble ");}
if (arrs[12]==2){strcpy(sh, "spike ");}
if (arrs[12]==3){strcpy(sh, "cross ");}
if (arrs[12]==4){strcpy(sh, "round ");}	 	 
printf("                                                                              .\n");
printf("How many ");
printf(sc);
printf(sh);
printf("flowers are there?\n");
}
