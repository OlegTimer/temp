...
//
for (int i = 0; i<lines_num; i++){
int col = i+(vec[p][2]*scr_coef)+scr_shift; 
...
if (answ!=0 && answ!=1 && answ!=2){showsprite();}
//showwin();			 
}//show end
...
if (dis<collideclose*2.1){close++;break;}
...
x1q.push_back(20); y_1q.push_back(20); x2q.push_back(20); y2q.push_back(-20); cq.push_back('^');
x1q.push_back(-20); y_1q.push_back(-20); x2q.push_back(20); y2q.push_back(-20); cq.push_back('#');
x1q.push_back(1); y_1q.push_back(1); x2q.push_back(2); y2q.push_back(1); cq.push_back('%');
x1q.push_back(1); y_1q.push_back(2); x2q.push_back(2); y2q.push_back(2); cq.push_back('+');
x1q.push_back(2); y_1q.push_back(2); x2q.push_back(2); y2q.push_back(1); cq.push_back('=');
x1q.push_back(1); y_1q.push_back(1); x2q.push_back(1); y2q.push_back(2); cq.push_back('@');
...
for (int i = 0; i<	lines_num; i++){
	vector<char> v;
	for (int j = 0; j<	lines_num; j++){
if (i<lines_num/2)	{	v.push_back('W');} else {v.push_back('L');}
		}
	spritet.push_back(v);	
	}	
for (int i =24; i<	32; i++){for (int j = 24; j<	32; j++){spritet[i][j]='o'; }}
...
spriteid.push_back(0); spritex.push_back(0);	spritey.push_back(1);
spriteid.push_back(1); spritex.push_back(-19);	spritey.push_back(19);	
...
cout<<"_ Ray casting 2.5 D ASCII v005 Win by OlegTim _\n\n";
...
cout<<"Press any key to start. <Esc> to quit\n";
