...
cout <<"\n";		
for(int i=0;i<lines_num;i++){for(int j=0;j<symbols_in_line;j++){cout<<scr[i][j];}
//cout<<"\n";
}
...
show();
cout<<"_ Ray casting 2.5 D ASCII v001 by OlegTim _\n\n";
cout<<"Adjust console, please: \n";
...
cout<<"Press 'w' to move forward and to start. \n";
